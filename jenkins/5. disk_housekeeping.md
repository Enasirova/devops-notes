# Task: monitor disk space in jenkins:

-> well we need to check only /opt line -> i can see that 77 percent is used, so we are good:

![](images/screenshot-20260210-113008.png)
